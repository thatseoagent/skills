...
> **That SEO Agent house rule:** Spanish (`es`) copy must never use em dashes at all — use commas, colons, or parentheses. English copy follows the "rare, deliberate emphasis only" guideline above.
